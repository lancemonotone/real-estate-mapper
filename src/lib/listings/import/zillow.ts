...
function extractZillowAmenities(text: string): string[] {
  ...
  const rules: Array<{ pattern: RegExp; pick: (m: RegExpMatchArray) => string }> = [
    ...
    { pattern: /\bVolleyball Court\b/i, pick: () => 'Volleyball Court' },
    { pattern: /\bPickleball(?:\s+Court)?\b/i, pick: () => 'Pickleball' },
    { pattern: /\bHot Tub\b/i, pick: () => 'Hot Tub' },
    { pattern: /\bJacuzzi\b/i, pick: () => 'Jacuzzi' },
    { pattern: /\bSauna\b/i, pick: () => 'Sauna' },
    { pattern: /\bHeated Pool\b/i, pick: () => 'Heated Pool' },
    { pattern: /\bSaltwater Pool\b/i, pick: () => 'Saltwater Pool' },
    { pattern: /\bLap Pool\b/i, pick: () => 'Lap Pool' },
    { pattern: /\bLazy River\b/i, pick: () => 'Lazy River' },
    { pattern: /\bSplash Pad\b/i, pick: () => 'Splash Pad' },
    { pattern: /\bFire Pit\b/i, pick: () => 'Fire Pit' },
    { pattern: /\bMovie Theater\b/i, pick: () => 'Movie Theater' },
    { pattern: /\bPutting Green\b/i, pick: () => 'Putting Green' },
    { pattern: /\bCabana\b/i, pick: () => 'Cabana' },
    {
    ...
    { pattern: /\bSwimming Pool\b/i, pick: () => 'Swimming Pool' },
    { pattern: /\bCommunity Spa\b/i, pick: () => 'Spa' },
    {
