...
const RENAME: Record<string, string> = {
  ...
  'saltwater pool': 'Saltwater Pool',
  'lap pool': 'Lap Pool',
  'resort-style pool': 'Resort-Style Pool',
  'hot tub': 'Hot Tub',
  jacuzzi: 'Jacuzzi',
  spa: 'Spa',
  sauna: 'Sauna',
  ...
  'pet park': 'Bark Park',
  'pet spa': 'Pet Spa',
  'climate-controlled bike station': 'Climate-Controlled Bike Station',
  'community courtyard': 'Community Courtyard',
  'golf cart parking': 'Golf Cart Parking',
  ...
  'surface lot parking': 'Surface Lot Parking',
  'shared laundry': 'Shared Laundry',
  deck: 'Deck',
